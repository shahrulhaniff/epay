...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "Paparan 1 to 10 of 57 entries") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Paparan _START_ to _END_ of _TOTAL_ entries
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Paparan halaman _PAGE_ dari _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "Paparan _START_ ke _END_ dari _TOTAL_ data",
			 ...
			 *  @type string
			 *  @default Paparan 0 to 0 of 0 entries
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Paparan 0 ke 0 dari 0 data",
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the 'Paparan x of y records' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
